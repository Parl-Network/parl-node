...
// bind addresses
pub const DEFAULT_P2P_BIND_ADDRESS: &str = "0.0.0.0:4454";
pub const DEFAULT_RPC_BIND_ADDRESS: &str = "0.0.0.0:4455";
...
pub const DEV_ADDRESS: &str = "ztx:nrgpm5lwrqlcsyh35s0h7res8c0yhkf5rmgv276vxr4d7nm0qfasqd2e753";
