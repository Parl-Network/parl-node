...
pub enum WalletError {
    ...
    #[error("Your wallet don't have enough funds to pay fees: expected {} but have only {}", format_parl(*_0), format_parl(*_1))]
    ...
    #[error("Invalid fees provided, minimum fees calculated: {}, provided: {}", format_parl(*_0), format_parl(*_1))]
