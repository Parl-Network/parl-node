...
// Format value using PARL decimals
pub fn format_parl(value: u64) -> String {
    format_coin(value, COIN_DECIMALS)
}

// Convert a PARL amount from string to a u64
pub fn from_parl(value: impl Into<String>) -> Option<u64> {
...
// the fee is calculated in atomic units for PRL
