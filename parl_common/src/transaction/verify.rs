...
impl Transaction {
    ...
    fn verify_commitment_assets(&self) -> bool {
        ...
        // PARL_ASSET is always required for fees
        if !has_commitment_for_asset(&PARL_ASSET) {
            return false;
        }
